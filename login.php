...
<body style="overflow-y:hidden;">
    ...
    <div class="login">
        ...
        ?>
            ...
            <p>
                <center><a href="login1.php?login=notyet" style="text-decoration:none;font-size:20px;color:white">New User?</a></center>
            </p>

            <p>
                <center><a href="home.php?login=no" style="text-decoration:none;font-size:20px;color:white">HOME</a></center>
            </p>
    </div>
